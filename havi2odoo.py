...
# Nombres de producto y UdM VERIFICADOS contra producción el 18/08/2026.
DEFAULT_PRODUCT_MAP: dict[str, tuple[str, str]] = {
    "EMPANADA ATÚN": ("Empanada Atún", "Caja 40 Uds"),
    "EMPANADA CEBOLLA CARAMELIZADA": ("Empanada Cebolla caramelizada", "Caja 40 Uds"),
    "EMPANADA CHEESEBURGUER": ("Empanada CheeseBurguer", "Caja 40 Uds"),
    "EMPANADA CHOCO PLÁTANO": ("Empanada Choco plátano", "Caja 40 Uds"),
    "EMPANADA ESPINACA Y EMMENTAL": ("Empanada Espinaca y emmental", "Caja 40 Uds"),
    "EMPANADA JAMÓN Y QUESO": ("Empanada Jamón y queso", "Caja 40 Uds"),
    "EMPANADA MANZANA Y CANELA": ("Empanada Manzana y canela", "Caja 40 Uds"),
    "EMPANADA MOZZARELLA Y OLIVADA": ("Empanada Mozzarella y olivada", "Caja 40 Uds"),
    "EMPANADA POLLO AL CURRY": ("Empanada Pollo al curry", "Caja 40 Uds"),
    "EMPANADA POLLO ASADO": ("Empanada Pollo Asado", "Caja 40 Uds"),
    "EMPANADA POLLO THAI": ("Empanada Pollo Thai", "Caja 40 Uds"),
    "EMPANADA PROVOLONE Y TOMATE": ("Empanada Provolone y tomate", "Caja 40 Uds"),
    "EMPANADA PULLED PORK XXL": ("Empanada Pulled Pork XXL", "Caja 40 Uds"),
    "EMPANADA SETAS Y CAMEMBERT": ("Empanada Setas y Camembert", "Caja 40 Uds"),
    "EMPANADA TERNERA PICANTE": ("Empanada Ternera picante", "Caja 40 Uds"),
    "EMPANADA TERNERA ROYALE": ("Empanada Ternera Royale", "Caja 40 Uds"),
    "EMPANADA TERNERA SUAVE": ("Empanada Ternera suave", "Caja 40 Uds"),
    "EMPANADA TOMATE Y ALBAHACA": ("Empanada Tomate y albahaca", "Caja 40 Uds"),
    "EMPANADA TÜNA": ("Empanada Tüna", "Caja 40 Uds"),
    "SALSA CHIMICHURRI": ("Salsa Chimichurri", "kg"),
    "ALFAJOR": ("Alfajores", "Caja de 27"),
    "CAJA 4 MUNS": ("Caja 4 Muns", "Pack 100"),
    "CAJA 8 MUNS": ("Caja 8 Muns", "Pack 100"),
    "CAJA 12 MUNS": ("Caja 12 Muns", "Pack 100"),
    "SEPARADOR CAJA 4": ("Separador Caja 4", "Pack 100"),
    "SEPARADOR CAJA 8": ("Separador Caja 8", "Pack 100"),
    "SEPARADOR CAJA 12": ("Separador Caja 12", "Pack 100"),
    "PAPEL ANTIADHERENTE GRANDE": ("Papel antiadherente Grande", "Pack 1000"),
    "PAPEL ANTIADHERENTE MEDIANO": ("Papel antiadherente Mediano", "Pack 1000"),
}
